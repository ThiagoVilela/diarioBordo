...
public class AddAvaliacao {
	...
	private void initialize() {
		...
		JLabel lblVocEstEm = new JLabel("Voc\u00EA est\u00E1 em 'Adicionar Avalia\u00E7\u00E3o'");
		lblVocEstEm.setBounds(63, 53, 203, 14);
		...
		addBotao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Avaliacao avaliacao = new Avaliacao(nome,tipo,peso,media,date);
				
				Aplicacao.bd.getTurmas().get(posicaoTurma).getAvaliacoesFormativas().add(avaliacao);
